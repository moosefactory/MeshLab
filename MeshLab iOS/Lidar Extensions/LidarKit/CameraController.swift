...
class CameraController: NSObject, ObservableObject {
    ...
    private let videoQueue = DispatchQueue(label: "com.moosefactory.MeshLab.VideoQueue", qos: .userInteractive)
    ...
    required init(errorClosure: @escaping (Error)->Void,
                  availableColusre: @escaping (CameraController)->Void) {
